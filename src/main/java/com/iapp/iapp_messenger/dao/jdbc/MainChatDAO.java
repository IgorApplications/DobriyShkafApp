...
public class MainChatDAO {
    ...
    private long getNewID() {
        return jdbcTemplate.query("SELECT * FROM Message ORDER BY id DESC LIMIT 1", new LegacyMessageMapper())
