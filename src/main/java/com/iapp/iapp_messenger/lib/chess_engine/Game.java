...
public class Game {
    ...
    private ArrayList<Move> getPieceMoves(int x, int y) {
        if (getColor(x, y) != colorMove) return new ArrayList<>(0);
    ...
    private ArrayList<Move> getQueenMoves(int x, int y) {
        ArrayList<Move> queenMoves = getRookMoves(x, y);
        queenMoves.addAll(getBishopMoves(x, y));

        return queenMoves;
    }

    private ArrayList<Move> getKnightMoves(int x, int y) {
    ...
    private void addValidKnightMove(ArrayList<Move> knightMoves, int x, int y, int moveX, int moveY) {
    ...
    private ArrayList<Move> getBishopMoves(int x, int y) {
    ...
    private ArrayList<Move> getRookMoves(int x, int y) {
    ...
    private ArrayList<Move> getKingMoves(int x, int y) {
    ...
    private ArrayList<Move> getPawnMoves(int x, int y) {
    ...
    private void addKingMove(ArrayList<Move> moves, int figureX, int figureY, int x, int y, int sign) {
        if (current.getPiece(x, y) * sign >= 1 || isCage(x, y)) {
            moves.add(Move.valueOf(figureX, figureY, x, y));
        }
    }

    private ArrayList<Move> getCastleMoves(int pieceX, int pieceY) {
        if (!isKing(pieceX, pieceY) || isKingMadeMove()) return new ArrayList<>(0);
    ...
    private ArrayList<Move> getMovesToSaveKing(ArrayList<Move> moves) {
        ArrayList<Move> saving = new ArrayList<>();
