...
import com.iapp.iapp_messenger.dao.jdbc.MainChatDAO;
...
public class LegacyMainChatController {

    private static final Logger mainChatLogger = LoggerFactory.getLogger(LegacyMainChatController.class);
    ...
    @Autowired
    public LegacyMainChatController(MainChatDAO mainChatDAO, LegacyAccountDAO accountDAO) {
