...
import com.iapp.iapp_messenger.dao.jdbc.LegacyAccountDAO;
import com.iapp.iapp_messenger.dao.jdbc.LegacyGamesDAO;
import com.iapp.iapp_messenger.lib.chess_engine.Color;
import com.iapp.iapp_messenger.lib.chess_engine.Game;
import com.iapp.iapp_messenger.lib.chess_engine.Result;
import com.iapp.iapp_messenger.lib.multiplayer.Match;
import com.iapp.iapp_messenger.lib.multiplayer.TurnMode;
...
public class LegacyGamesController {
    ...
    private static final Logger gamesLogger = LoggerFactory.getLogger(LegacyGamesController.class);
    private final LegacyAccountDAO accountDAO;
    private final LegacyGamesDAO gamesDAO;
     ...
     * */
    private final List<LegacyMatchChessEngine> engineList = new CopyOnWriteArrayList<>();

    @Autowired
    public LegacyGamesController(LegacyGamesDAO gamesDAO, LegacyAccountDAO accountDAO) {
    ...
    public RequestStatus start(long authId, long gameId) {
        ...
        var engine = new LegacyMatchChessEngine(match, accountDAO);
        engine.start();
    ...
    private List<LegacyMatchChessEngine> findMatch(long matchId) {
