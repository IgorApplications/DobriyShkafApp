package com.iapp.iapp_messenger.controllers.low_ws;

import com.google.gson.Gson;
import com.iapp.iapp_messenger.lib.multiplayer.Match;
import com.iapp.iapp_messenger.lib.ui.RdLogger;
import com.iapp.iapp_messenger.lib.util.Pair;
import com.iapp.iapp_messenger.lib.web.*;
...
//@Component
public class LegacyWebSocketHandler extends AbstractWebSocketHandler {

    private static final long ACCOUNT_UPDATE_TIME = 30 * 60 * 1000;
    private static final long MAIN_CHAT_UPDATE_TIME = 60 * 1000;
    private static final Logger websocketLogger = LoggerFactory.getLogger(LegacyWebSocketHandler.class);
    private static final Object MUTEX = new Object();

    private final Gson gson = new Gson();
    private final ExecutorService service = Executors.newSingleThreadExecutor();

    private final LegacyAccountController legacyAccountController;
    private final LegacyMainChatController mainChatController;
    private final LegacyGamesController gamesController;
    /**
    ...
    @Autowired
    public LegacyWebSocketHandler(LegacyAccountController legacyAccountController,
                                  LegacyMainChatController mainChatController,
                                  LegacyGamesController gamesController) {
        this.legacyAccountController = legacyAccountController;
            ...
            switch (data[0]) {
                ...
                case 0: {
                    ...
                    if (loginAccount != null) {
                        ...
                        requestStatus = legacyAccountController.updateAvatar(loginAccount, pair.getKey(), pair.getValue());
                    }
                ...
                case 1: {
                    ...
                    if (loginAccount != null) {
                        ...
                        var pair = legacyAccountController.getAvatar(id);
    ...
    private SocketResult requireFromAccounts(WebSocketSession session, String accountReq, SocketRequest socketRequest) {
        ...
        switch (accountReq) {
            ...
            case "/login": {
                ...
                var res = legacyAccountController.login(
            ...
            case "/signup": {
                ...
                return new SocketResult(legacyAccountController.signup(params[0], params[1], params[2]),
                        socketRequest);
            }

            case "/see": {

                var pair = legacyAccountController.see(Long.parseLong(params[0]));
            ...
            case "/seeAccounts": {
                ...
                var pair = legacyAccountController.seeAccounts(ids);
                updateOnline(pair.getValue());
            ...
            case "/change": {
                ...
                return new SocketResult(legacyAccountController.change(loginAcc, params[0]),
                        socketRequest);
            }
            ...
            case "/getAllData": {
                ...
                return new SocketResult(RequestStatus.DONE, gson.toJson(legacyAccountController.getAllData()),
                        socketRequest);
            }

            case "/search": {

                var accounts = legacyAccountController.searchAccounts(params[0]);
            ...
            case "/bullet": {
                Pair<RequestStatus, List<Account>> pair = legacyAccountController.getBulletTop();
                updateOnline(pair.getValue());
            ...
            case "/blitz": {
                Pair<RequestStatus, List<Account>> pair = legacyAccountController.getBlitzTop();
                updateOnline(pair.getValue());
            ...
            case "/rapid": {
                Pair<RequestStatus, List<Account>> pair = legacyAccountController.getRapidTop();
                updateOnline(pair.getValue());
            ...
            case "/long": {
                Pair<RequestStatus, List<Account>> pair = legacyAccountController.getLongTop();
                updateOnline(pair.getValue());
            ...
            case "/punish": {
                ...
                return new SocketResult(legacyAccountController.punish(loginAcc, id, punishment), socketRequest);
            }
            ...
            case "/makeInactive": {
                ...
                return new SocketResult(legacyAccountController.makeInactive(loginAcc, punishableId, punishmentId),
                    socketRequest);
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (System.currentTimeMillis() - lastUpdateAccounts > ACCOUNT_UPDATE_TIME) {
                        legacyAccountController.update();
