...
import com.iapp.iapp_messenger.lib.chess_engine.*;
import com.iapp.iapp_messenger.lib.multiplayer.Match;
import com.iapp.iapp_messenger.lib.multiplayer.TurnMode;
import com.iapp.iapp_messenger.lib.util.ELOCalculator;
import com.iapp.iapp_messenger.lib.util.Pair;
import com.iapp.iapp_messenger.lib.web.Account;
import com.iapp.iapp_messenger.lib.web.RankType;
import com.iapp.iapp_messenger.lib.web.RequestStatus;
 ...
 *
 * */
public class LegacyMatchChessEngine {

    private static final Logger matchChessEngineLogger = LoggerFactory.getLogger(LegacyMatchChessEngine.class);
    ...
    public RequestStatus makeMove(String fenMove) {
        synchronized (match) {
            ...
            if (!game.getMoves(move.getPieceX(), 7 - move.getPieceY())
                    .contains(normalMove) || updated == (pair.getValue() == null)) {
                return RequestStatus.DENIED;
            }
