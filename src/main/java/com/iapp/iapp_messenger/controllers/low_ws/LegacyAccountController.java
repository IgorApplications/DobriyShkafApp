...
import com.iapp.iapp_messenger.lib.web.Login;
import com.iapp.iapp_messenger.lib.web.Punishment;
...
public class LegacyAccountController {
    ...
    private static final Logger accountLogger = LoggerFactory.getLogger(LegacyAccountController.class);

    private final LegacyAccountDAO accountDAO;
    private final Gson gson;

    @Autowired
    public LegacyAccountController(LegacyAccountDAO accountDAO) {
     ...
     * @see LegacyAccountController#update()
     * */
